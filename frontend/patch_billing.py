...
if 'import { CountrySelect }' not in content:
    content = content.replace("import { formatPrice } from '../../data/pricingCatalog';", "import { formatPrice } from '../../data/pricingCatalog';\nimport { CountrySelect } from '../CountrySelect';")
...
# Replace the existing toggle
regex = r'<div className="flex items-center justify-center gap-2 bg\[#030303\].*?Annual.*?</div>'
content = re.sub(regex, selector_code, content, flags=re.DOTALL)
