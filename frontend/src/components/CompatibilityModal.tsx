...
export const CompatibilityModal: React.FC<CompatibilityModalProps> = ({
  ...
  const SelectOption = ({ label, selected, onClick, description }: { key?: string | number, label: string, selected: boolean, onClick: () => void, description?: string }) => (
    <button
      onClick={onClick}
    ...
    <AnimatePresence>
      ...
      <div className="bg-[#050505] w-full h-full md:h-auto md:max-h-[95vh] md:max-w-5xl md:rounded-2xl border-0 md:border border-white/10 shadow-2xl flex flex-col overflow-hidden relative">
        ...
        <div className="flex items-center justify-between p-4 md:px-8 md:py-6 border-b border-white/10 sticky top-0 bg-[#050505]/95 backdrop-blur z-20">
          <div>
            <div className="text-xs font-bold tracking-[0.2em] text-sky-400 mb-1">SENSA COMPATIBILITY CHECK</div>
            <h2 className="text-xl md:text-2xl font-bold text-white">Is Your System Ready for SENSA?</h2>
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 relative z-10">
          ...
          {step === 1 && (
            <div className="max-w-2xl mx-auto space-y-10 pb-20 md:pb-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="space-y-2 text-center md:text-left">
                ...
                <p className="text-slate-400">SENSA is designed to work with common IP camera and RTSP/ONVIF environments.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <SelectOption label="RTSP" description="SENSA can use an RTSP stream when the required stream configuration is supported." selected={cameraProtocol === 'RTSP'} onClick={() => setCameraProtocol('RTSP')} />
          ...
          {step === 2 && (
            <div className="max-w-2xl mx-auto space-y-10 pb-20 md:pb-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="space-y-2 text-center md:text-left">
                <h3 className="text-2xl font-bold text-white">Where will SENSA run?</h3>
                <p className="text-slate-400">SENSA can be deployed on customer-managed computers or supported edge hardware, depending on the workload.</p>
              </div>
              ...
              {hardwareType === 'NVIDIA Edge Device' && (
                <div className="space-y-6 animate-in fade-in duration-300 bg-slate-900/30 p-6 rounded-2xl border border-white/5">
                  ...
                  <div className="flex gap-2 text-sm text-slate-400 bg-slate-900 p-3 rounded-lg border border-slate-800">
                    <Info size={16} className="text-sky-400 shrink-0 mt-0.5" />
                    <span>GPU acceleration availability depends on the SENSA deployment package and model configuration.</span>
                  </div>
                </div>
              )}
          ...
          {step === 3 && (
            <div className="max-w-2xl mx-auto space-y-10 pb-20 md:pb-0 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4">
                <label className="text-sm font-semibold text-slate-300">Can the SENSA Agent reach the camera streams?</label>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 text-sm text-slate-400 bg-slate-900/50 p-3 rounded-lg border border-slate-800">
                  <Info size={16} className="text-sky-400 shrink-0 mt-0.5" />
                  <span>Internet connectivity requirements depend on your selected SENSA deployment and alerting configuration.</span>
                </div>
              </div>
              ...
              {hasNvr === 'Yes' && (
                <div className="space-y-4 animate-in fade-in slide-in-from-top-2 p-6 bg-slate-900/30 rounded-2xl border border-white/5">
                  ...
                  <div className="text-sm text-slate-400 mt-3 text-center">SENSA compatibility depends on whether the NVR provides a supported stream interface.</div>
                </div>
              )}
          ...
          {step === 4 && (
            <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-500 pb-10">
              <div className="text-center space-y-2">
                <h2 className="text-3xl font-bold text-white">Your SENSA Compatibility Result</h2>
              ...
              <div className={`p-6 md:p-8 rounded-2xl border bg-opacity-10 ${getStatusColor(overallStatus())} flex flex-col md:flex-row items-center md:items-start gap-6`}>
                ...
                <div className="text-center md:text-left space-y-3">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    {overallStatus() === 'READY' && 'Your environment appears ready for a SENSA deployment.'}
                  ...
                  <div className="pt-4 flex flex-wrap gap-3 justify-center md:justify-start">
                    ...
                    {overallStatus() === 'NEEDS REVIEW' && (
                      <button onClick={onTalkToSales} className="px-6 py-2.5 bg-amber-500 hover:bg-amber-400 text-black font-bold rounded-full transition-colors flex items-center gap-2">
                        Talk to SENSA <ArrowRight size={16} />
                      </button>
                    )}
              ...
              <div className="bg-slate-900/30 border border-slate-800 rounded-2xl p-6">
                <h3 className="text-lg font-bold text-white mb-4">Recommended SENSA Setup</h3>
              ...
              <div className="bg-[#0f111a] border border-white/10 rounded-2xl p-6 md:p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                  ...
                  <p className="text-slate-400 text-sm mb-6">Send your configuration to the SENSA team and we'll review your environment.</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-slate-500 text-center mt-3">
                      Your compatibility information is used to evaluate your SENSA deployment requirements. See our Privacy Policy for information about how submitted information is processed.
                    </p>
                  </div>
                </div>
              </div>
